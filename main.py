...
def main():
    ...
    parser.add_argument("-b", "--browser", help="Select the output browser")
    parser.add_argument(
        "--version",
        action="store_true",
...
def convert_json_to_html(json_data: dict):
...
def convert_to_bookmarks(spaces: dict, items: list):
...
def convert_bookmarks_to_html(bookmarks: dict):
...
def write_html(html_content: str, output: Path = None):
